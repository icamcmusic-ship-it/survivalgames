        ...
        {fallen.map((t, idx) => (
          ...
          >
             <div className="relative mb-3">
                <div className="w-20 h-20 rounded-full grayscale brightness-50 contrast-125 border-2 border-gray-700 bg-gray-800 flex items-center justify-center overflow-hidden group-hover:border-blood transition-colors">
